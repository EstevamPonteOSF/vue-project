<template>
    <v-card class="book-card mx-auto">
        <div
        ...
        <v-card-title>
            <span>
                {{ book.volumeInfo.title.substring(0, maxTitleLength) }}
            </span>
...
<script>
    ...
    import ForwardNavigationButton from '../navegation/ForwardNavigationButton.vue';
